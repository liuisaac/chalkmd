    ...
    return (
        <div
            className={`${
                isOpen
                    ? "bg-topbar"
                    : "bg-offwhite transition duration-400 delay-100"
        ...
        >
            <div className="flex flex-col items-center justify-center text-gray-500 mt-10">
                ...
                <FileSearchCorner size={18} className="mb-5" />
                <Network size={18} className="mb-5 rotate-180" />
                <LayoutDashboard size={18} className="mb-5" />
                <Calendar size={18} className="mb-5" />
                <Files size={18} className="mb-5" />
