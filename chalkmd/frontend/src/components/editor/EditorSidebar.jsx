...
const EditorSidebar = ({ files, onFileClick }) => {
    const minimumWidth = 235;
    const collapseThreshold = 100; // Collapse when dragged below this width
    ...
    useEffect(() => {
        const handleMouseMove = (e) => {
            ...
            // Otherwise, keep it open and set width within constraints
    ...
    return (
        <div 
            ref={sidebarRef}
            className="bg-topbar border-r-[1px] border-[#E0E0E0] relative flex flex-col h-screen transition-all duration-0"
            style={{ width: `${width}px` }}
        >
            {/* Fixed sections - these don't scroll */}
